...
public class TestGetSection {
    ...
    public static void main(String args[]) {
        ...
        Company c1 = new Company("Java Online Projects", "http://javaops.ru/");
        CompanyPeriod p1 = new CompanyPeriod(YearMonth.of(2013, 10),
                YearMonth.now(), "Автор проекта.", "Создание, организация и проведение Java онлайн проектов и стажировок.");

        Company c2 = new Company("Wrike", "https://www.wrike.com/");
        CompanyPeriod p2 = new CompanyPeriod(YearMonth.of(2014, 10),
                YearMonth.of(2016, 1), "Старший разработчик (backend)",
                "Проектирование и разработка онлайн платформы управления проектами Wrike (Java 8 API, Maven, Spring, MyBatis, Guava, Vaadin, PostgreSQL, Redis). Двухфакторная аутентификация, авторизация по OAuth1, OAuth2, JWT SSO.");

        Company c3 = new Company("RIT Center");
        ...
        Company c4 = new Company("Luxoft (Deutsche Bank)", "http://www.luxoft.ru/");
        ...
        Company c5 = new Company("Yota", "https://www.yota.ru/");
        ...
        Company c6 = new Company("Enkata", "http://enkata.com/");
        ...
        Company c7 = new Company("Siemens AG", "https://www.siemens.com/ru/ru/home.html");
        ...
        Company c8 = new Company("Alcatel", "http://www.alcatel.ru/");
        ...
        experience.addCompany(c1, p1);
        experience.addCompany(c2, p2);
        experience.addCompany(c3, p3);
        experience.addCompany(c4, p4);
        experience.addCompany(c5, p5);
        experience.addCompany(c6, p6);
        experience.addCompany(c7, p7);
        experience.addCompany(c8, p8);

        Company c9 = new Company("Coursera", "https://www.coursera.org/course/progfun");
        ...
        Company c10 = new Company("Luxoft", "http://www.luxoft-training.ru/training/catalog/course.html?ID=22366");
        ...
        Company c11 = new Company("Siemens AG", "http://www.siemens.ru/");
        ...
        Company c12 = new Company("Alcatel", "http://www.alcatel.ru/");
        ...
        Company c13 = new Company("Санкт-Петербургский национальный исследовательский университет информационных технологий, механики и оптики", "http://www.ifmo.ru/");
        ...
        education.addCompany(c9,p9);
        education.addCompany(c10,p10);
        education.addCompany(c11,p11);
        education.addCompany(c12,p12);
        education.addCompany(c13,p13);
